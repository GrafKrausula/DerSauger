...
Function CheckPython39
    ...
    StrCpy $Python39Path "C:\Users\$Username\AppData\Local\Programs\Python39\python.exe"
    IfFileExists "$Python39Path" PathFound39
    ...
    ${If} $Python39Path == ""
        ...
        InstallNow:
            ...
            IfFileExists "C:\Users\$Username\AppData\Local\Programs\Python39\python.exe" 0 +2
                StrCpy $Python39Path "C:\Users\$Username\AppData\Local\Programs\Python39\python.exe"
                Goto PathFound39
    ...
    PathFound39:
        MessageBox MB_OK "Python 3.9 gefunden unter: C:\Users\$Username\AppData\Local\Programs\Python39\python.exe"
...
Function CheckNeededPythonVersionForPackages
    ...
    StrCpy $PythonPackageNeededPath "C:\Users\$Username\AppData\Local\Programs\Python$PythonPackageNeededVersion\python.exe"
    IfFileExists "$PythonPackageNeededPath" PathFound
    ...
    ${If} $PythonPackageNeededPath == ""
        ...
        InstallNow:
            ...
            ; Check direct path first after install
            IfFileExists "C:\Users\$Username\AppData\Local\Programs\Python$PythonPackageNeededVersion\python.exe" 0 +2
                StrCpy $PythonPackageNeededPath "C:\Users\$Username\AppData\Local\Programs\Python$PythonPackageNeededVersion\python.exe"
                Goto PathFound
    ...
    PathFound:
        MessageBox MB_OK "Python $PythonPackageNeededVersion gefunden unter: C:\Users\$Username\AppData\Local\Programs\Python$PythonPackageNeededVersion\python.exe"
